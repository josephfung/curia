...
export class Dispatcher {
  ...
  private async handleInbound(event: InboundMessageEvent): Promise<void> {
    ...
    // auto-gen handling after stampOriginator). Replaces the repeated
    ...
    // Stamp TaskOriginator before auto-generated handling so principal-originated
    // forwards (e.g. Fwd: OOO) are not silently dropped — same shape as #1732.
    //
