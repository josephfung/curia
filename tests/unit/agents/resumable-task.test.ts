...
import type { ResumableProgressBlock } from '../../../src/db/resumable-progress.js';
import { readResumableBlock } from '../../../src/db/resumable-progress.js';
import { computeResumableThroughput } from '../../../src/agents/resumable-throughput.js';
import type { ResumableCircuitState } from '../../../src/agents/resumable-circuit-breaker.js';
...
describe('parseExecutionPausedPayload negative paths (#1174)', () => {
  ...
  it('does not warn-with-stack for a plain-prose specialist reply (#1871)', () => {
    const warn = vi.fn();
    const logger = { warn } as unknown as import('../../../src/logger.js').Logger;
