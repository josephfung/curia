...
} from '../../../src/autonomy/approval-notification.js';
...
describe('shared notification body — both call sites', () => {
  it('approval-trigger and outbound-gateway use the same builder for equivalent inputs', async () => {
    const { buildApprovalNotificationBody: fromTrigger } = await import('../../../src/autonomy/approval-notification.js');
    const { buildApprovalNotificationBody: fromGateway } = await import('../../../src/autonomy/approval-notification.js');
