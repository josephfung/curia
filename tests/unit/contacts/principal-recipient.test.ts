...
} from '../../../src/contacts/principal-recipient.js';
import {
  PRINCIPAL_CHANNEL_RULES,
  assertPrincipalChannelRegistryUnique,
  findPrincipalChannelRules,
} from '../../../src/contacts/principal-channel-registry.js';
import type { PrincipalChannelRules } from '../../../src/contacts/principal-channel-rules.js';
