...
import { EmailListFoldersHandler } from '../../../skills/email/tools/email-list-folders/handler.js';
...
function makeCtx(input: Record<string, unknown>, overrides?: Partial<ToolContext>): ToolContext {
  return { toolName: 'email-list-folders', toolVersion: '1.0.0', input, secret: () => { throw new Error('no secrets'); }, log: logger, ...overrides };
}
