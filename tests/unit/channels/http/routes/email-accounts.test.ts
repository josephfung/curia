...
import { emailAccountsRoutes, type EmailAccountsRouteOptions } from '../../../../../src/channels/http/routes/email-accounts.js';
import type { EmailAccountRow } from '../../../../../src/channels/email/email-accounts-repo.js';
...
async function build(
  ...
  const options: EmailAccountsRouteOptions = {
    ...
    sessions: new Map(),
    repoForTest: repo as import('../../../../../src/channels/email/email-accounts-repo.js').EmailAccountsRepo,
  };
