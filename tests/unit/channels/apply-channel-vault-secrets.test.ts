...
import { DEFAULT_VOICE_LIVEKIT_MANAGEMENT_URL } from '../../../src/config.js';
import { applyChannelVaultSecrets } from '../../../src/channels/apply-channel-vault-secrets.js';
...
function baseConfig(): Config {
  return {
    ...
    signalVoiceCallsEnabled: false,
    signalPulseSocketPath: undefined,
    signalVoiceMaxCallSeconds: 600,
