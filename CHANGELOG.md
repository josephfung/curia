...
- **Auto-generated mail detection** — inbound email is classified from message signals (not contact `kind`); replies are suppressed at dispatch while the agent still judges escalation. (#1734)
...
- **Inbound voice notes** — Signal and Slack audio attachments transcribe to inbound messages. (#1600)
...
- **Tool-failure honesty** — failed tool calls now carry a reporting constraint the model must not contradict. (#1546)
