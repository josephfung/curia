...
- [Autonomy Engine Design](../wip/2026-04-03-autonomy-engine-design.md) — how `action_risk` gates execution (Phase 2 hard gates, Phase 3 auto-adjustment)
