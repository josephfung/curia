...
If your specialist agent needs to make autonomy-gated decisions independently (rare), pass `autonomyService` in its `AgentRuntime` config. See `docs/wip/2026-04-03-autonomy-engine-design.md` for the full design.
