...
- Knowledge skills (`knowledge-company-overview`, `knowledge-meeting-links`, `knowledge-writing-config`, etc.) — structured KG queries (legacy pattern — use `config-store` for new agents)
