...
Two refinements land here (now documented in `docs/specs/03-tools-and-execution.md` — the `elevated` = live-principal-turn gate — and `docs/specs/14-autonomy-engine.md` — effective standing):
