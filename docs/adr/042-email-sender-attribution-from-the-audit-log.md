...
Contact recall becomes correct on 748 historical email threads covering 176 contacts, including every thread that later resumes. Long-running correspondence, which the tier exists to serve and which is the most likely to carry pre-090 turns, stops silently dropping Curia's own replies.
